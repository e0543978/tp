...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + EMAIL_DESC_BOB + NATIONALITY_DESC_BOB
                + TUTORIAL_GROUP_DESC_BOB + SOCIAL_HANDLE_DESC_AMY + SOCIAL_HANDLE_DESC_BOB
                + TAG_DESC_FRIEND, new AddCommand(expectedPerson));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + VALID_EMAIL_BOB + VALID_NATIONALITY_BOB
                + VALID_TUTORIAL_GROUP_BOB + VALID_SOCIAL_HANDLE_BOB, expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + EMAIL_DESC_BOB + NATIONALITY_DESC_BOB
                + TUTORIAL_GROUP_DESC_BOB + SOCIAL_HANDLE_DESC_BOB
        ...
        assertParseFailure(parser, NAME_DESC_BOB + EMAIL_DESC_BOB + NATIONALITY_DESC_BOB
                + INVALID_TUTORIAL_GROUP_DESC + SOCIAL_HANDLE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, TutorialGroup.MESSAGE_CONSTRAINTS);

        // invalid social handle
        assertParseFailure(parser, NAME_DESC_BOB + EMAIL_DESC_BOB + NATIONALITY_DESC_BOB
                + TUTORIAL_GROUP_DESC_BOB + INVALID_SOCIAL_HANDLE_DESC
